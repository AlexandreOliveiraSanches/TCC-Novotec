          ...
          <tbody>
            ...
            while($row = $result->fetch_assoc()) {
              ...
              <tr>
                  ...
                  <td>$row[editora]</td>
                  <td>
                      <a class='btn btn-secondary btn-sm' href='/assets/pages/editLivro.php?id=$row[id]'><i class='bi bi-pencil-square'></i>Editar</a>
                      <a class='btn btn-danger btn-sm' href='/assets/pages/deleteLivro.php?id=$row[id]'><i class='bi bi-trash3'></i>Excluir</a>
                  </td>
              </tr>
              ";
            }
